...
<script setup>
import { ref } from "vue";
import { usePlatformRestrictions } from "@/composables/usePlatformRestrictions";

// 平台限制
const { canUpload, canModify, restrictToDesktop } = usePlatformRestrictions();
